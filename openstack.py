...
class OpenStack(object):
    ...
    def list_vms(self):
        ...
        """
        params = '{auth{"passwordCredentials":{"username":%s, "password":%s}, "tenantId":"%s"}}' % (settings.get(
            'OPENSTACK', 'USER'), settings.get('OPENSTACK', 'PASS'), settings.get('OPENSTACK', 'TENANT_ID'))
